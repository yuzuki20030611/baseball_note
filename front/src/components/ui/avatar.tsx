...
// ChakraAvatar.RootProps の代わりに React.ComponentProps を使用
export interface AvatarProps extends React.ComponentProps<typeof ChakraAvatar.Root> {
  name?: string
  src?: string
  srcSet?: string
...
// ChakraAvatar.FallbackProps の代わりに React.ComponentProps を使用
interface AvatarFallbackProps extends React.ComponentProps<typeof ChakraAvatar.Fallback> {
  name?: string
  icon?: React.ReactElement
}
