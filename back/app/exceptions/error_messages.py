...
class ErrorMessage:
    ...
    class FILE_NOT_FOUND(BaseMessage):
        status_code = status.HTTP_404_NOT_FOUND
        text = "ファイルが見つかりません"

    class FILE_UPLOAD_FAILED(BaseMessage):
        status_code = status.HTTP_500_INTERNAL_SERVER_ERROR
        text = "ファイルアップロードに失敗しました"

    class INVALID_REQUEST(BaseMessage):
